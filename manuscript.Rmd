...
MEME Suite focuses on sequence data as the centerpoint of analysis, but in the
case of ChIP-seq, data are often stored as genomic coordinates with additional
metadata columns, such as `GRanges` objects in R/Bioconductor. 
