...
across a broad range of biological contexts [@Bailey2009]. With over 22,000
...
`memes` enables complex data-aware differential motif analysis workflows using
...
the full results can be viewed in **Table 1**. This analysis revealed
...
factors Br, L(3)neo38, Gl, and Lola (**Table 1**). These data support
...
[snystrom.github.io/memes](snystrom.github.io/memes). The `memes_docker` container  is available on dockerhub: [https://hub.docker.com/r/snystrom/memes_docker](https://hub.docker.com/r/snystrom/memes_docker),
...
[github.com/snystrom/memes_paper/](github.com/snystrom/memes_paper/). Data used in this manuscript were from: [GSE141738](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE141738).
