...
```{r tomtom_example, fig.height=3, fig.width=7.5, fig.cap="\\label{fig:tomtom_example}Representative plots generated by view_tomtom_hits showing the top hit for motifs discovered in decreasing (A) and increasing (B) peaks."}
