...
\cite{splitapplycombine, whickham}. Together, these features empower users to
...
list members. By passing multiple names to `control`, the sequences are
combined together to create a merged background set.
